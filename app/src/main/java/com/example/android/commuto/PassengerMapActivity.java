...
public class PassengerMapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private Button mSignOut, mRequest, mSettings, mHistory;
        ...
        mCustomerDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists() && dataSnapshot.getChildrenCount()>0){
                    if(dataSnapshot.child("First Name")!=null && dataSnapshot.child("Last Name") != null){
                        mDriverName.setText(dataSnapshot.child("First Name").getValue().toString() + dataSnapshot.child("Last Name").getValue().toString());
                    }
                    if(dataSnapshot.child("Phone Number")!=null){
                        mDriverPhone.setText(dataSnapshot.child("Phone Number").getValue().toString());
                    }
 ...
 /*   private DatabaseReference driveHasEndedRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loactionEnable = (Button) findViewById(R.id.myLocation);
        loactionEnable.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (ActivityCompat.checkSelfPermission(PassengerMapActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) !=
                        PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(PassengerMapActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
     ...
     /*   mDriverInfo = (LinearLayout) findViewById(R.id.driverInfo);
        ...
        AutocompleteFilter typeFilter = new AutocompleteFilter.Builder().setCountry("IND")
                .build();
        ...
        placeAutocompleteFragment.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(Place place) {
                ...
                mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(pickupLocation, 18));
                mMap.setMaxZoomPreference(18);
                mMap.setMinZoomPreference(15);
                placeBool = true;
      ...
      /*  mHistory.setOnClickListener(new View.OnClickListener() {
        ...
        AutocompleteFilter typeFilter2 = new AutocompleteFilter.Builder().setCountry("IND")
                .build();

        autocompleteFragment.setHint("Enter Destination");


        autocompleteFragment.setFilter(typeFilter2);
        ...
        autocompleteFragment.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(Place place) {
                ...
                destinationMarker = mMap.addMarker(new MarkerOptions().position(destinationLatLng).title("Your Destination").
                        icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE)));
                mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(destinationLatLng, 18));
            }
                    ...
                    mCustomerDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            if (dataSnapshot.exists() && dataSnapshot.getChildrenCount() > 0) {
                                ...
                                driverRef.child("customerRideId").setValue(customerId);
                                driverRef.child("destination").setValue(destination);
                                driverRef.child("destinationLat").setValue(destinationLatLng.latitude);
                                driverRef.child("destinationLng").setValue(destinationLatLng.longitude);

                                getDriverLocation();
                                //   getDriverInfo();
                                //  getHasRideEnded();
                                mRequest.setText("Looking for Toto...");
                                //  }
                            }
                        }
            ...
            public void onGeoQueryReady() {
                ...
                if (!driverFound) {
                    if (radius < 2.0) {
                        ...
                        mRequest.setText("No nearby toto were found");
                }
            }
    ...
    private void endRide() {
        ...
        mRequest.setText("Book your ride");
